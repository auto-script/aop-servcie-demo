 ...
 */
@Slf4j
public class JedisClusterStrategy implements RedisStrategy {

  Set<HostAndPort> jedisClusterNodes = new HashSet<>();
  JedisCluster jedis;

  public JedisClusterStrategy(String host, int port, String nodes, int timeout) {
    ...
    jedis = new JedisCluster(jedisClusterNodes, timeout, 2);
  }
